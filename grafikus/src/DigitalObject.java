...
public abstract class DigitalObject {
	 ...
	 * 
	 * @return A kapu, composit vagy bemenet kimenetenek aktualis erteke, specialis esetekben (Composit)konstans 0
	 * @throws ExceptionsWithConnection Az elemek kozotti helytelen kapcsolatokbl szarmazo hibak
	 * @throws ExceptionUnstableCircuit Az adott elem(Composit) isntabil egy visszacsatolas maitt
	 */
	...
	public String GetType() {
		return (ID.split(strIDDelimiter)[1]).trim();
	}
	/**
