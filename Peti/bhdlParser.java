...
public class bhdlParser {
    ...
    //Composite-ot kap és kiszedi a következő parancsot by Peti
    ...
    public static String find_header(String source) {
        ...
        Pattern regexp = Pattern.compile(".+[^a-zA-Z]in.*(,.+?)*,out.*(,.+?)*[^a-zA-Z0-9=; |&!,_]");//Regexp tetszőleges karakterek nemABCszám karakter ( ( )in felsorolás vessző tetszőleges karakterekkel, out felsorolás vessző tetszőleges karakterekkel optimálisan amjd egy nem betűszám= ; karakter ( ) )
        // Megkeress�k a tal�latokat
        Matcher match = regexp.matcher(source);
        // Els� kell
        String foundComposit = "";
