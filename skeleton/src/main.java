...
public class main {
	...
	//ezt a warningot az eclipse miatt kell berakni.. a nevezés miatt a def konstr bekevert.
	...
	public static void main(String[] args) {
		...
		while(!line.contentEquals("exit")){	//Míg nem akar kilépni a feslhasználó nem lépünk ki			;
			...
			System.out.println("  7 - Step Components(Visszacsatolással, instabilra állítható");
